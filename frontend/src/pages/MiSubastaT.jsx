...
export default function MiSubastaT() {
  ...
  return (
    <div className="w-full flex flex-col items-center px-8 bg-[#00684a]">
      <div className="pb-2">
        ...
        <p className="text-center mt-3 text-white text-lg"> Para crear una subasta primero debes crear una finca. Luego, agregas las variedades que tienes en tu finca y ya por fin puedes agregar una subasta </p>
      </div>
