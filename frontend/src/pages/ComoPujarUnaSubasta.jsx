...
function ComoPujarUnaSubasta() {
  return (
    <div className='py-6'>
      <h2 className="font-semibold text-3xl text-center mb-8 mt-4 ">Cómo pujar en una subasta</h2>
      <p className="mb-4 font-normal text-lg text-[#919190]  text-center">
        Para pujar en una subasta en nuestra plataforma, sigue estos sencillos pasos:
      </p>
      <h3 className="font-semibold text-3xl mb-4  ">1. Inicia sesión</h3>
      <p className="mb-4 font-normal text-lg text-[#919190] ">
        Ingresa con tu correo electrónico y contraseña en nuestra plataforma.
      </p>
      <h3 className="font-semibold text-3xl mb-4 ">2. Busca la subasta de tu interés</h3>
      <p className="mb-4 font-normal text-lg text-[#919190]  ">
      ...
      <h3 className="font-semibold text-3xl mb-4 ">3. Accede a la subasta</h3>
      <p className="mb-4 font-normal text-lg text-[#919190] ">
      ...
      <h3 className="font-semibold text-3xl mb-4 ">4. Inserta tus ofertas</h3>
      <p className="mb-4 font-normal text-lg text-[#919190] ">
      ...
      <h3 className="font-semibold text-3xl mb-4 ">5. Chat después de la subasta</h3>
      <p className="mb-4 font-normal text-lg text-[#919190] ">
