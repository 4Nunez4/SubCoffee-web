...
function QuienesSomosA() {
  return (
    <div className="mt-24 flex justify-center flex-col items-center w-full px-44 mb-8">
      <h1 className="text-3xl font-bold text-center">Quiénes Somos</h1>
      <img src="./src/assets/comunidad.avif" alt="" className='w-96 my-8 rounded-3xl h-auto' />
