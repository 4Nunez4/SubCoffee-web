...
function PoliticasYCondicionesPageA() {
  return (
    <div className="flex flex-col items-center justify-center bg-[#FDFBF6]">
      <h2 className="font-semibold text-3xl text-center mb-8 mt-10">Políticas de privacidad</h2>
      <div className=" py-6 w-full b overflow-y-auto max-w-7xl px-12">
        <section id="primera">
          <div className="flex-grow">
            <h2 className="font-semibold text-3xl mb-4 ">Fecha de efectividad</h2>
            ...
            <div className="flex flex-col md:flex-row items-start mb-6">
              ...
              />
              <div>
                <h2 className="font-semibold text-3xl mb-4">Descripción del Servicio</h2>
                <p className="font-normal text-lg text-[#919190]">
        ...
        <section>
          <h2 className="font-semibold text-3xl mb-4">Registro de Usuarios</h2>
          <p className="font-normal text-lg text-[#919190]">
        ...
        <section>
          <h2 className="font-semibold text-3xl mb-4">Privacidad y Protección de Datos</h2>
          <p className="font-normal text-lg text-[#919190]">
        ...
        <section>
          <h2 className="font-semibold text-3xl mb-4">Cookies y Tecnologías de Seguimiento</h2>
          <p className="font-normal text-lg text-[#919190]">
        ...
        <section>
          <h2 className="font-semibold text-3xl mb-4">Uso de los Servicios</h2>
          <p className="font-normal text-lg text-[#919190]">Al utilizar los Servicios de SubCoffe, usted se compromete a:</p>
        ...
        <section>
          <h2 className="font-semibold text-3xl mb-4">Derechos de Propiedad Intelectual</h2>
          <p className="font-normal text-lg text-[#919190]">
        ...
        <section>
          <h2 className="font-semibold text-3xl mb-4">Modificación de los Términos</h2>
          <p className="font-normal text-lg text-[#919190]">
        ...
        <section>
          <h2 className="font-semibold text-3xl mb-4">Limitación de Responsabilidad</h2>
          <p className="font-normal text-lg text-[#919190]">
        ...
        <section>
          <h2 className="font-semibold text-3xl mb-4">Jurisdicción y Ley Aplicable</h2>
          <p className="font-normal text-lg text-[#919190]">
