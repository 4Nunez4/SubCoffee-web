...
function PoliticasYCondicionesPage() {
    return (
        <div>
            ...
            <p>Bienvenido/a a la plataforma de subastas de café en línea. En esta página, nos preocupamos profundamente por la privacidad y seguridad de nuestros usuarios. Por ello, hemos desarrollado esta política detallada que explica cómo recopilamos, usamos, compartimos y protegemos la información personal que usted nos proporciona. Al utilizar nuestros servicios, usted acepta los términos descritos a continuación.</p>

            <h3>Información que Recopilamos</h3>
            <p>Recopilamos varios tipos de información para mejorar su experiencia de usuario y ofrecer un servicio de calidad:</p>
            <ul>
            ...
            <p>Respetamos su privacidad y solo compartimos su información en las siguientes circunstancias:</p>
            <ul>
            ...
            <p>Implementamos medidas de seguridad físicas, técnicas y administrativas para proteger su información contra el acceso no autorizado, pérdida o alteración.</p>

            <h3>Cookies y Tecnologías Similares</h3>
            <p>Utilizamos cookies y tecnologías similares para mejorar su experiencia en línea. Puede ajustar la configuración de su navegador para rechazar cookies, pero esto puede afectar la funcionalidad de nuestro sitio.</p>

            <h3>Privacidad de Menores</h3>
            <p>Nuestros servicios no están dirigidos a menores de 18 años. No recopilamos intencionalmente información personal de menores sin el consentimiento de los padres o tutores.</p>

            <h3>Cambios en la Política de Privacidad</h3>
            <p>Nos reservamos el derecho de actualizar esta política en cualquier momento. Le notificaremos sobre cambios significativos mediante un aviso en nuestro sitio web o por correo electrónico.</p>

            <h3>Contacto</h3>
            <p>Si tiene alguna pregunta sobre nuestra política de privacidad o desea acceder, corregir o eliminar su información personal, contáctenos a través de [correo electrónico] o nuestra dirección postal.</p>
