    ...
    const renderCell = useCallback((results, columnKey) => {
        ...
        switch (columnKey) {
        case "nombre_tipo_vari":
            return (
            <Chip className="capitalize" color={statusColorMap[results.nombre_tipo_vari]} size="sm" variant="flat">
                {cellValue}
            </Chip>
            );
        case "actions":
    ...
    const topContent = useMemo(() => {
        ...
        <div className="flex flex-col gap-4 px-10 pt-10">
            ...
            <span className="text-default-400 text-small">
                Total {results && results.length} Tipo
            </span>
    ...
    return (
        ...
        >
            ...
            <TableBody emptyContent={"Tipo de variedad NULL"} items={sortedItems}>
            {(item) => (
