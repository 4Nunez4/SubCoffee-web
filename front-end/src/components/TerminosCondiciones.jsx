export const TerminosyCondiciones = () => {
  return (
    <div className="min-h-screen flex items-center justify-center w-full p-4">
      <div className="bg-white bg-white-900 shadow-md rounded-lg px-8 py-6 max-w-4xl border border-gray-700 overflow-y-auto">
        ...
        <p className="mb-2">-No utilizar los Servicios para fines ilegales o no autorizados.</p>
        <p className="mb-2">-No recopilar información de otros usuarios sin su consentimiento.</p>
        <p className="mb-2">-Mantener la confidencialidad de su contraseña y otros datos de acceso a su cuenta.</p>
        <p className="mb-2">-No publicar contenido falso, inexacto, engañoso, difamatorio o de naturaleza ofensiva.</p>
        <p className="mb-2">-Cumplir con todas las leyes locales, nacionales e internacionales aplicables.</p>
