        ...
        <div className="min-h-screen flex items-center justify-center w-full">
            ...
            <div className="bg-white dark:bg-white-600 shadow-md rounded-lg px-8 py-6 max-w-md border border-gray-700">
                ...
                <form action="#">
                    ...
                    <button onClick={() => alert("WENASSS")} type="submit" className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Iniciar Sesión</button>
                    <a className="text-xs text-gray-600 focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700">¿No tienes una cuenta? </a>
