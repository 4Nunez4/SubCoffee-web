...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-07-2024 a las 17:52:02
...
(2, 1, 3, 'Me parece que es una buena persona', '2024-07-18 12:38:08', 2);
...
(38, 'Mi Segunda Finca', 'rivage-w4Q9l03Qq4o-unsplash.jpg', 'activo', 1, 2),
(39, 'Mi primer finca', 'WhatsApp Image 2024-06-08 at 2.44.38 PM.jpeg', 'activo', 4, 1),
(40, 'Mi nueva finca', 'pexels-nguyendesigner-22043102.jpg', 'activo', 1, 12),
(41, 'La Palestina', 'pexels-karolina-grabowska-4750261.jpg', 'activo', 1, 107),
(42, 'La  Palesina 2', 'pexels-kampus-7658794.jpg', 'activo', 321321, 107);
...
(15, 'mensaje', '2024-07-11 12:15:43', 'Nueva subasta creada', 38, 1),
(16, 'mensaje', '2024-07-12 14:46:33', 'Nueva subasta creada', 39, 1),
(17, 'mensaje', '2024-07-18 14:24:37', 'Nueva subasta creada', 40, 321321);
...
(74, '2024-07-18 12:45:37', 489000, 2, 36),
(75, '2024-07-18 12:55:59', 689000, 2, 36),
(76, '2024-07-18 14:27:03', 180000, 2, 40),
(77, '2024-07-18 14:27:33', 380000, 3, 40);
...
(30, '2024-06-09 03:40:00', '2024-06-09 04:40:00', 'WhatsApp Image 2024-06-08 at 2.44.54 PM.jpeg', 99000, 0, 'Kilogramo', 18, 'cerrada', 'requerimientos_juan.docx', 'Es una muy buena subasta', 26, 0),
(31, '2024-06-09 14:20:00', '2024-06-09 14:40:00', 'WhatsApp Image 2024-06-08 at 2.42.26 PM.jpeg', 450000, 0, 'Tonelada', 1, 'cerrada', 'Instructivo 4-Utilizar react native Select List en el proyecto formativoyecto formativo.pdf', 'Es un café de mucha calidad', 26, 0),
...
(36, '2024-07-18 12:45:00', '2024-07-18 12:56:00', 'WhatsApp Image 2024-06-08 at 2.42.26 PM.jpeg', 89000, NULL, 'Kilogramo', 80, 'espera', 'Instructivo 4-Utilizar react native Select List en el proyecto formativoyecto formativo.pdf', 'Un buen café', 27, NULL),
(37, '2024-06-09 20:20:00', '2024-06-09 20:35:00', 'WhatsApp Image 2024-06-08 at 2.44.38 PM.jpeg', 56000, 0, 'Libra', 60, 'cerrada', 'Instructivo 4-Utilizar react native Select List en el proyecto formativoyecto formativo.pdf', 'Un café unico y exclusivo', 28, 0),
(38, '2024-07-11 12:15:00', '2024-07-12 12:15:00', 'busqueda-de-lupa.png', 500000, 0, 'Kilogramo', 60, 'cerrada', 'Pres SubCoffee.pptx', 'Un muy buen producto', 26, 0),
(39, '2024-07-12 20:10:00', '2024-07-12 20:30:00', 'ochir-erdene-oyunmedeg-LmyPLbbUWhA-unsplash.jpg', 80000, 0, 'Kilogramo', 100, 'cerrada', 'TRABAJO N.6.pdf', 'Un café dulce y agradable.', 29, 0),
(40, '2024-07-18 14:25:00', '2024-07-18 14:33:00', 'rivage-w4Q9l03Qq4o-unsplash.jpg', 80000, 380000, 'Kilogramo', 80, 'espera', '124362025 (1).pdf', 'Un café de muy alta calidad', 34, 3);
...
(1, 'vendedor', 'vendedor@gmail.com', '$2b$12$af5bnP76MuPb3IwdEsqcROiAuNt6HjOQjdhFwPtfAV0RcNAG5oJeO', '', 'pexels-kampus-7658794.jpg', '3167654352', 'vendedor', 'activo'),
...
(123456, 'admin', 'admin@gmail.com', '$2b$12$sfx4cyI/O.lJ1cgGyAeEy.QbRDp2ox.TbMzJU487RtZv9njcOFBAy', 'Mi descripción', 'imagen_perfil5.jpg', '3214131', 'admin', 'activo'),
(321321, 'Wilson', 'wilson@gmail.com', '$2b$12$7uE2jVERBq7tHeDPizQIauUiWxUHd35e2yAzVmDIS0ko6z9mMUWAS', '', '5576227d98fd1f39766045e053607cf5.jpg', '31254852', 'vendedor', 'activo');
...
--
ALTER TABLE `notificaciones`
  MODIFY `pk_id_not` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT de la tabla `ofertas`
--
ALTER TABLE `ofertas`
  MODIFY `pk_id_ofer` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;

--
-- AUTO_INCREMENT de la tabla `postulantes`
--
ALTER TABLE `postulantes`
  MODIFY `pk_id_post` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `variedad`
  MODIFY `pk_id_vari` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT de la tabla `veredas`
--
ALTER TABLE `veredas`
  MODIFY `pk_id_vere` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=108;
