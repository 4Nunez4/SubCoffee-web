...
export const validarRegistrarSubasta = [
  ...
  check(
    "precio_inicial_sub",
    "El precio inicial es requerido y debe ser un número"
  )
    .not()
    .isEmpty()
    .exists()
  ...
  check(
    "unidad_peso_sub",
    "La unidad de peso es requerida y debe ser una de las siguientes: Gramo, Libra, Kilogramo, Tonelada"
  )
    .not()
    .isEmpty()
    .exists()
...
export const validarActualizarSubasta = [
  ...
  check(
    "estado_sub",
    "El estado es requerido y debe ser uno de los siguientes: abierta, espera, cerrada, proceso"
  )
    .not()
    .isEmpty()
    .exists()
