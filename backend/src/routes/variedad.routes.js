...
import { activarVariedad, cargarImagen, createVariedad, deleteVariedad, desactivarVariedad, getVariedadUser, getVariedades, updateVariedad } from "../controllers/variedad.controller.js";
...
routerVariedad.get("/variedaduser/:id", verificarUserToken, getVariedadUser);
